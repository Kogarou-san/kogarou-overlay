...
HOMEPAGE="http://www.aegisub.org/ https://github.com/arch1t3cht/Aegisub"
...
if [[ ${PV} == *9999 ]]; then
	...
	SRC_URI="https://github.com/arch1t3cht/Aegisub/archive/v${PV}.tar.gz -> ${P}.tar.gz"
	KEYWORDS="~amd64 ~x86"
fi
LICENSE="BSD MIT"
SLOT="0"
IUSE="+alsa debug +fftw openal portaudio pulseaudio spell test +uchardet avisynth+ vapoursynth"
RESTRICT="test"
